...
import { openInNewTab } from '../utils/linksUtils';

const StyledTableCell = withStyles((_: Theme) =>
  createStyles({
    head: {
...
const StatusDetails = () => {
  ...
  return (
    <Grid container spacing={2} alignItems='center' direction='column'>
      <Grid item xs={12}>
        <IconButton aria-label="refresh" color='primary' onClick={() => dispatch(statusFetchStarted())}>
          <SyncRoundedIcon />
        </IconButton>
      </Grid>
      <Grid item xs={12}>
